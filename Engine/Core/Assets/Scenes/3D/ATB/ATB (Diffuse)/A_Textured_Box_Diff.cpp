...
GLFWwindow* Scene::onInit()
{
    ...
    BoxShader.setShader("Core/Assets/Scenes/3D/ATB/ATB (Diffuse)/Shaders/colors.vert", "Core/Assets/Scenes/3D/ATB/ATB (Diffuse)/Shaders/colors.frag");
    LightShader.setShader("Core/Assets/Scenes/3D/ATB/ATB (Diffuse)/Shaders/light_cube.vert", "Core/Assets/Scenes/3D/ATB/ATB (Diffuse)/Shaders/light_cube.frag");

    // ---------------------------------- //
    // ----- Texture Initialization ----- //
    // ---------------------------------- //

    Diffuse.setTexture("Core/Assets/Scenes/3D/ATB/ATB (Diffuse)/Textures/BrickWall_Diff.png", "diff", true);
...
void Scene::onUpdate(GLFWwindow* window)
{
    ...
    BoxShader.setBind3f("objectColor", 1.0f, 0.5f, 0.31f);
    BoxShader.setBind3f("lightColor", 1.0f, 1.0f, 1.0f);
