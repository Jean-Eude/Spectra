...
GLFWwindow* Scene::onInit()
{
    ...
    BoxShader.setShader("Core/Assets/Scenes/3D/ATB/ATB (Specular)/Shaders/colors.vert", "Core/Assets/Scenes/3D/ATB/ATB (Specular)/Shaders/colors.frag");
    LightShader.setShader("Core/Assets/Scenes/3D/ATB/ATB (Specular)/Shaders/light_cube.vert", "Core/Assets/Scenes/3D/ATB/ATB (Specular)/Shaders/light_cube.frag");

    // ---------------------------------- //
    // ----- Texture Initialization ----- //
    // ---------------------------------- //

    Diffuse.setTexture("Core/Assets/Scenes/3D/ATB/ATB (Specular)/Textures/MetalWeave_Diff.png", "diff", true);
...
void Scene::onUpdate(GLFWwindow* window)
{
    ...
    BoxShader.setBind1f("Shininess", shininess);
