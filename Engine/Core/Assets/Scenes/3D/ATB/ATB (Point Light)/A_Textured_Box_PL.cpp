...
GLFWwindow* Scene::onInit()
{
    ...
    BoxShader.setShader("Core/Assets/Scenes/3D/ATB/ATB (Point Light)/Shaders/colors.vert", "Core/Assets/Scenes/3D/ATB/ATB (Point Light)/Shaders/colors.frag");
    LightShader.setShader("Core/Assets/Scenes/3D/ATB/ATB (Point Light)/Shaders/light_cube.vert", "Core/Assets/Scenes/3D/ATB/ATB (Point Light)/Shaders/light_cube.frag");

    // ---------------------------------- //
    // ----- Texture Initialization ----- //
    // ---------------------------------- //

    Diffuse.setTexture("Core/Assets/Scenes/3D/ATB/ATB (Point Light)/Textures/BrickWall_Diff.png", "diff", true);
    Specular.setTexture("Core/Assets/Scenes/3D/ATB/ATB (Point Light)/Textures/BrickWall_Spec.png", "spec", true);
...
void Scene::onUpdate(GLFWwindow* window)
{
    ...
    Camera.Setup(width, height, cameraPos, cameraFront, cameraUp, true, false, false, lightPos, scaleDR, axesDR, angleDR, FOVcamkey, LightShader);
    ...
    ImGui::Text("Position");
    ImGui::SliderFloat("xDir", &lightPos[0], -20.0f, 20.0f);  ImGui::SliderFloat("yDir", &lightPos[1], -20.0f, 20.0f);  ImGui::SliderFloat("zDir", &lightPos[2], -20.0f, 20.0f);
