...
GLFWwindow* Scene::onInit()
{
    ...
    BoxShader.setShader("Core/Assets/Scenes/3D/ATB/ATB (Directionnal Light)/Shaders/colors.vert", "Core/Assets/Scenes/3D/ATB/ATB (Directionnal Light)/Shaders/colors.frag");
    LightShader.setShader("Core/Assets/Scenes/3D/ATB/ATB (Directionnal Light)/Shaders/light_cube.vert", "Core/Assets/Scenes/3D/ATB/ATB (Directionnal Light)/Shaders/light_cube.frag");

    // ---------------------------------- //
    // ----- Texture Initialization ----- //
    // ---------------------------------- //

    Diffuse.setTexture("Core/Assets/Scenes/3D/ATB/ATB (Directionnal Light)/Textures/BrickWall_Diff.png", "diff", true);
    Specular.setTexture("Core/Assets/Scenes/3D/ATB/ATB (Directionnal Light)/Textures/BrickWall_Spec.png", "spec", true);
...
void Scene::onUpdate(GLFWwindow* window)
{
    ...
    BoxShader.setBind3f("light.direction", lightDir);
    ...
    Camera.Setup(width, height, cameraPos, cameraFront, cameraUp, true, false, false, translateDR, scaleDR, axesDR, angleDR, FOVcamkey, LightShader);
    ...
    */
    ...
    ImGui::SliderFloat("xDir", &lightDir[0], -20.0f, 20.0f);  ImGui::SliderFloat("yDir", &lightDir[1], -20.0f, 20.0f);  ImGui::SliderFloat("zDir", &lightDir[2], -20.0f, 20.0f);
    ImGui::Text("Translation");
    ImGui::SliderFloat("xTrans", &translateDR[0], -20.0f, 20.0f);  ImGui::SliderFloat("yTrans", &translateDR[1], -20.0f, 20.0f);  ImGui::SliderFloat("zTrans", &translateDR[2], -20.0f, 20.0f);
    ImGui::Spacing();
