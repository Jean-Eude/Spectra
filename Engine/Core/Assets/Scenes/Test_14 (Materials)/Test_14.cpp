...
GLFWwindow* Scene::onInit()
{
    ...
    lightingShader.setShader("Core/Assets/Scenes/Test_14 (Materials)/Shaders/colors.vert", "Core/Assets/Scenes/Test_14 (Materials)/Shaders/colors.frag");
    lightCubeShader.setShader("Core/Assets/Scenes/Test_14 (Materials)/Shaders/light_cube.vert", "Core/Assets/Scenes/Test_14 (Materials)/Shaders/light_cube.frag");
    ...
    Model.loadModel("Core/Assets/Scenes/Test_14 (Materials)/Models/backpack.obj");
...
void Scene::onUpdate(GLFWwindow* window)
{
    ...
    lightingShader.setBind3f("material.ambient", 1.0f, 0.5f, 0.31f);
    lightingShader.setBind3f("material.diffuse", 1.0f, 0.5f, 0.31f);
    lightingShader.setBind3f("material.specular", 0.5f, 0.5f, 0.5f);
