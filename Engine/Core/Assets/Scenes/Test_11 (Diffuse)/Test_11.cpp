...
GLFWwindow* Scene::onInit()
{
    ...
    lightingShader.setShader("Core/Assets/Scenes/Test_11 (Diffuse)/Shaders/colors.vert", "Core/Assets/Scenes/Test_11 (Diffuse)/Shaders/colors.frag");
    lightCubeShader.setShader("Core/Assets/Scenes/Test_11 (Diffuse)/Shaders/light_cube.vert", "Core/Assets/Scenes/Test_11 (Diffuse)/Shaders/light_cube.frag");
    ...
    Model.loadModel("Core/Assets/Scenes/Test_11 (Diffuse)/Models/backpack.obj");
