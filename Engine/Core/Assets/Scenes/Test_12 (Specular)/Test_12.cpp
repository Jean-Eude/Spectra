...
GLFWwindow* Scene::onInit()
{
    ...
    lightingShader.setShader("Core/Assets/Scenes/Test_12 (Specular)/Shaders/colors.vert", "Core/Assets/Scenes/Test_12 (Specular)/Shaders/colors.frag");
    lightCubeShader.setShader("Core/Assets/Scenes/Test_12 (Specular)/Shaders/light_cube.vert", "Core/Assets/Scenes/Test_12 (Specular)/Shaders/light_cube.frag");
    ...
    Model.loadModel("Core/Assets/Scenes/Test_12 (Specular)/Models/backpack.obj");
